...
import com.pagil.teruel_express.jwt.JwtAuthenticationEntryPoint;
import com.pagil.teruel_express.jwt.JwtAuthorizationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/avaliacoes/landing").permitAll()
...
//                        .requestMatchers(HttpMethod.POST, "/codigo/validar").permitAll()
